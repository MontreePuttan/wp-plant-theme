...
$GLOBALS['s_blog_show_profile']		= '1';
$GLOBALS['s_shop_layout'] 				= 'leftbar';
$GLOBALS['s_shop_mainpage'] 			= 'default';
...
function plant_register_required_plugins() {
	$plugins = array(
		array(
			...
			'source'             => get_template_directory() . '/vendor/nextend/smartslider3-wordpress-3.2.4-pro-stable.zip',
			'required'           => false,
			'version'            => '3.2.4',
		...
		array(
			'name'               => 'Kirki',
			'slug'               => 'kirki',
			'source'             => get_template_directory() . '/vendor/kirki/kirki.3.0.9.zip',
			'required'           => true,
			'version'            => '3.0.9',
