...
<body <?php body_class($bodyClass); ?>>
	...
	<div id="page" class="site -layout-<?php echo $GLOBALS['s_layout']; ?> -header-mobile-<?php echo $GLOBALS['s_header_mobile']; ?> -header-desktop-<?php echo $GLOBALS['s_header_desktop']; ?> -menu-<?php echo $GLOBALS['s_menu']; ?> -menu-icon-<?php echo $GLOBALS['s_menu_icon'] ; ?> -shop-layout-<?php echo $GLOBALS['s_shop_layout']; ?>">
		...
		<nav id="site-mobile-navigation" class="site-mobile-navigation <?php if($GLOBALS['s_menu'] == 'off-canvas') { echo 'sb-slidebar sb-right'; } else { echo '-dropdown'; } ?> _mobile _heading" role="navigation">
		...
		<header id="masthead" class="site-header sb-slide _heading " role="banner">
			<div class="container">
				...
				<a class="site-toggle <?php if($GLOBALS['s_menu'] == 'off-canvas') { echo 'sb-toggle-right'; } ?> _mobile">
					<i><span></span><span></span><span></span><span></span></i><b><?php esc_html_e( 'Menu', 'plant' ); ?></b>
				</a>
			...
			if (is_front_page()) {
				...
				if (is_active_sidebar( 'page_banner' )) {
					...
					if ($GLOBALS['s_header_desktop'] == 'overlay') {
						...
						printf(__('If you would like to use different Widgets on each page, we reccommend <a href="%s" target="_blank">Widget Options Plugin</a>.', 'plant') , 'https://wordpress.org/plugins/widget-options/');
						echo '</div>';
					}
					if ($GLOBALS['s_header_mobile'] == 'overlay') {
